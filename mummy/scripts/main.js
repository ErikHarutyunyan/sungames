...
"use strict"; {
    ...
    const r = class extends DOMHandler {
        ...
        _OnMouseEvent(b, c, d) {
            a(c) || ("mousedown" === b && window !== window.top && window.focus(), this._PostToRuntimeMaybeSync(b, {
                "button": c.button,
                "buttons": c.buttons,
                "clientX": c.clientX,
                "clientY": c.clientY,
        ...
        _OnPointerEvent(a, b) {
            "pointerdown" === a && window !== window.top && window.focus(), this._pointerRawUpdateRateLimiter && "pointermove" !== a && this._pointerRawUpdateRateLimiter.Reset();
            let c = 0;
    ...
    const b = class extends DOMHandler {
        ...
        _UnblockAudioContext() {
            if (!this._hasUnblocked) {
                ...
                c["buffer"] = b, c["connect"](a["destination"]), c["start"](0), "running" === a["state"] && (this._hasUnblocked = !0, window.removeEventListener("pointerup", this._unblockFunc, !0), window.removeEventListener("touchend", this._unblockFunc, !0), window.removeEventListener("click", this._unblockFunc, !0), window.removeEventListener("keydown", this._unblockFunc, !0), this._unblockFunc = null)
            }
        }
        GetAudioContext() {
