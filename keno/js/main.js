  ...
  function p(a) {
    ...
    "IE" == q && /\blike iPhone OS\b/.test(a)
      ...
      ? (E &&
        ...
        : "Silk" == q
        ? (/\bMobi/i.test(a) || ((r = "Android"), l.unshift("desktop mode")),
        ...
        ? (q &&
            ...
            (q = null),
          (g = z || E || r) &&
            (z || E || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(r)) &&
            (q =
    ...
    if (
      (g =
        ("iCab" == y && 3 < parseFloat(h) && "WebKit") ||
        (/\bOpera\b/.test(q) && (/\bOPR\b/.test(a) ? "Blink" : "Presto")) ||
        (/\b(?:Midori|Nook|Safari)\b/i.test(a) &&
          !/^(?:Trident|EdgeHTML)$/.test(y) &&
          "WebKit") ||
        (!y && /\bMSIE\b/i.test(a) && ("Mac OS" == r ? "Tasman" : "Trident")) ||
        ("WebKit" == y && /\bPlayStation\b(?! Vita\b)/i.test(q) && "NetFront"))
    )
      y = [g];
    ...
    if (G) {
      if (e(w, "global"))
            ...
            ("object" == typeof g.versions &&
              ("string" == typeof g.versions.electron
                ? (l.push("Node " + g.versions.node),
                  (q = "Electron"),
                  (h = g.versions.electron))
                : "string" == typeof g.versions.nw &&
                  (l.push("Chromium " + h, "Node " + g.versions.node),
                  (q = "NW.js"),
                  (h = g.versions.nw))),
            q ||
              ((q = "Node.js"),
        ...
        f((g = w.runtime)) == C
          ...
          ? ((h = [h, M.documentMode]),
            (g = +g[1] + 4) != h[1] &&
              (l.push("IE " + h[1] + " mode"), y && (y[1] = ""), (h[1] = g)),
            (h = "IE" == q ? String(h[1].toFixed(1)) : h[0]))
          : "number" == typeof M.documentMode &&
            /^(?:Chrome|Firefox)\b/.test(q) &&
            (l.push("masking as " + q + " " + h),
            (q = "IE"),
            (h = "11.0"),
            (y = ["Trident"]),
            (r = "Windows"));
    ...
    h &&
      (g =
        ...
        /(?:alpha|beta)(?: ?\d)?/i.exec(a + ";" + (G && u.appMinorVersion)) ||
        (/\bMinefield\b/i.test(a) && "a")) &&
      ((L = /b/i.test(g) ? "beta" : "alpha"),
      (h =
        h.replace(RegExp(g + "\\+?$"), "") +
        ("beta" == L ? R : Q) +
        (/\d+\+?/.exec(g) || "")));
    if (
      ...
      "Xbox 360" == z && (r = null),
        "Xbox 360" == z && /\bIEMobile\b/.test(a) && l.unshift("mobile mode");
    else if (
      (!/^(?:Chrome|IE|Opera)$/.test(q) &&
        (!q || z || /Browser|Mobi/.test(q))) ||
      ("Windows CE" != r && !/Mobi/i.test(a))
    )
      if ("IE" == q && G)
        try {
          null === w.external && l.unshift("platform preview");
        } catch (O) {
          l.unshift("embedded");
        }
      else
        (/\bBlackBerry\b/.test(z) || /\bBB10\b/.test(a)) &&
        (g =
          (RegExp(z.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(a) ||
            0)[1] || h)
          ? ((g = [g, /BB10/.test(a)]),
            (r =
              (g[1] ? ((z = null), (E = "BlackBerry")) : "Device Software") +
              " " +
              g[0]),
            (h = null))
          : this != d &&
            ...
            ((G && F) ||
              ...
              ("IE" == q &&
                ((r && !/^Win/.test(r) && 5.5 < h) ||
                  (/\bWindows XP\b/.test(r) && 8 < h) ||
                  (8 == h && !/\bTrident\b/.test(a))))) &&
            !v.test((g = p.call(d, a.replace(v, "") + ";"))) &&
            g.name &&
            ...
            v.test(q)
              ? (/\bIE\b/.test(g) && "Mac OS" == r && (r = null),
                (g = "identify" + g))
              : ((g = "mask" + g),
                (q = J ? b(J.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera"),
                /\bIE\b/.test(g) && (r = null),
                G || (h = null)),
            (y = ["Presto"]),
            l.push(g));
    ...
    if ((g = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(a) || 0)[1])) {
      ...
      if ("Safari" == q && "+" == g[1].slice(-1))
        (q = "WebKit Nightly"), (L = "alpha"), (h = g[1].slice(0, -1));
      else if (
        h == g[1] ||
        h == (g[2] = (/\bSafari\/([\d.]+\+?)/i.exec(a) || 0)[1])
      )
        h = null;
    ...
    "Opera" == q && (g = /\bzbov|zvav$/.exec(r))
      ...
      : "Safari" == q &&
        ...
        (q = "Chrome Mobile"),
        (h = null),
        /\bOS X\b/.test(r) ? ((E = "Apple"), (r = "iOS 4.3+")) : (r = null));
    h &&
      0 == h.indexOf((g = /[\d.]+$/.exec(r))) &&
      -1 < a.indexOf("/" + g + "-") &&
      (r = String(r.replace(g, "")).replace(/^ +| +$/g, ""));
    y &&
      !/\b(?:Avant|Nook)\b/.test(q) &&
      (/Browser|Lunascape|Maxthon/.test(q) ||
        ("Safari" != q && /^iOS/.test(r) && /\bSafari\b/.test(y[1])) ||
    ...
    (g = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(K)) && !/\bi686\b/i.test(K)
      ? (r &&
          ((r.architecture = 64),
    ...
    r &&
      q &&
      (r != String(r).split(" ")[0] || (r != q.split(" ")[0] && !z)) &&
      l.push(z ? "(" + r + ")" : "on " + r);
...
function sizeHandler() {
  ...
  if ($("#canvas")) {
    ...
    if (b < a) {
      ...
      d < c &&
        ((f = c - d), (d += f), (b += (CANVAS_HEIGHT / CANVAS_WIDTH) * f));
    f = a / 2 - b / 2;
    var e = c / 2 - d / 2,
      m = CANVAS_WIDTH / d;
    if (e * m < -EDGEBOARD_X || f * m < -EDGEBOARD_Y)
      (b = Math.min(
...
function createBitmap(a, c, b) {
  ...
  c && b
    ? f.graphics.beginFill("#fff").drawRect(0, 0, c, b)
...
function calculateIntersection(a, c) {
  ...
  k = Math.abs(k - n) - (d + e);
  return 0 > m && 0 > k
    ? ((m = Math.min(Math.min(a.width, c.width), -m)),
      (k = Math.min(Math.min(a.height, c.height), -k)),
      {
        x: Math.max(a.x, c.x),
        y: Math.max(a.y, c.y),
        width: m,
...
function getBounds(a, c) {
  ...
  if (a instanceof createjs.Container) {
    ...
    b.x = Math.min(Math.min(Math.min(f.x, m.x), e.x), d.x);
...
function CTextButton(a, c, b, d, f, e, m, k) {
  ...
  this.buttonDown = function () {
    ...
    l.scaleY = 0.9;
    n[ON_MOUSE_DOWN] &&
      n[ON_MOUSE_DOWN].call(t[ON_MOUSE_DOWN], p[ON_MOUSE_DOWN]);
  };
...
function CTextToggle(a, c, b, d, f, e, m, k) {
  ...
  this.buttonRelease = function () {
    n ||
      ...
      ((h.scaleX = 1 * p),
      (h.scaleY = 1 * p),
      l[ON_MOUSE_UP] && l[ON_MOUSE_UP].call(u[ON_MOUSE_UP]));
  };
  this.buttonDown = function () {
    n ||
      t ||
      ((h.scaleX = 0.9 * p),
      (h.scaleY = 0.9 * p),
      l[ON_MOUSE_DOWN] && l[ON_MOUSE_DOWN].call(u[ON_MOUSE_DOWN]));
  };
...
function CNumToggle(a, c, b, d) {
  ...
  this.buttonRelease = function () {
    e ||
      ...
      (f = !f),
      n.gotoAndStop("state_" + f),
      m[ON_MOUSE_UP] && m[ON_MOUSE_UP].call(k[ON_MOUSE_UP], h));
  };
  this.buttonDown = function () {
...
function CMenu() {
  ...
  this._init = function () {
    ...
    u &&
      ...
      (l = new CToggle(b, d, v, s_bFullscreen, !0)),
...
function CGame(a) {
  ...
  this._init = function () {
    ...
    D.visible = !1;
    s_oStage.addChild(D);
    if (d > f) for (a = 0; 80 > a; a++) n[a].block(!0);
  };
  this._initCells = function () {
    ...
    for (var e = 0, f = 0; 80 > f; f++)
      (n[f] = new CNumToggle(c + (f % 10) * b, d + a * e, f + 1, A)),
  ...
  this._onButNumRelease = function (a) {
    ...
    B.updatePayouts(e - 1);
    if (9 < e) for (b = 0; b < t.length; b++) t[b] || n[b].block(!0);
    else for (b = 0; b < t.length; b++) n[b].block(!1);
  };
  this._checkActiveButton = function () {
    2 > e
      ? (h.enablePlay1(!1), h.enablePlay5(!1))
      : (h.enablePlay1(!0), 5 * d > f ? h.enablePlay5(!1) : h.enablePlay5(!0));
  };
  this.clearSelection = function () {
    ...
    for (var a = 0; a < t.length; a++)
      (t[a] = !1), n[a].block(!1), n[a].setActive(!1);
    this._checkActiveButton();
  };
  ...
  this.tryShowAd = function () {
    p++;
    p === AD_SHOW_COUNTER &&
      ((p = 0), $(s_oMain).trigger("show_interlevel_ad"));
  };
  this.play = function () {
    this._clearAllExtracted();
    if (!(2 > e)) {
  ...
  this._extractWinCombination = function (a) {
    ...
    for (var b = [], d = PAYOUTS[e - 1].pays.length - 1; d >= a; d--)
      for (var f = 0; f < PAYOUTS[e - 1].occurrence[d]; f++)
        b.push(PAYOUTS[e - 1].hits[d]);
  ...
  this._animExtraction = function () {
    for (var a = [], b = 0; 20 > b; b++)
      a.push(n[u[b] - 1].getGlobalPosition());
    C.startAnimation(a);
  };
  ...
  this._clearAllExtracted = function () {
    ...
    for (a = 0; a < l.length; a++) n[l[a]].setActive(!0);
  };
  ...
  this.smartBlockGUI = function (a) {
    ...
    a
      ? ((D.visible = !1),
        h.enableAllButton(!0),
        5 * d <= f ? h.enablePlay5(!0) : h.enablePlay5(!1))
      : ((D.visible = !0), h.enableAllButton(!1));
  };
  ...
  this._init = function () {
    ...
    if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile)
      (x = s_oSpriteLibrary.getSprite("audio_icon")),
        (m = new CToggle(b, d, x, s_bAudioActive)),
    ...
    C &&
      ...
      (a = x.width / 4 + 10),
      (c = x.height / 2 + 10),
      (B = new CToggle(a, c, x, s_bFullscreen, !0)),
    ...
    A.addEventListener(ON_MOUSE_UP, this._onClear, this);
    this.refreshButtonPos(s_iOffsetX, s_iOffsetY);
  };
  this.unload = function () {
...
function CPayouts(a, c) {
  ...
  this._init = function (a, b) {
    ...
    for (c = 0; 6 > c; c++)
      (m[c] = 190 + 50 * c),
        (k[c] = new createjs.Text("-", "36px " + PRIMARY_FONT, "#ffffff")),
        (k[c].x = 80),
        (k[c].y = m[c]),
        (k[c].textAlign = "center"),
        (k[c].textBaseline = "middle"),
        f.addChild(k[c]),
        (p[c] = new createjs.Text("-", "36px " + PRIMARY_FONT, "#ffffff")),
        (p[c].x = 210),
        (p[c].y = m[c]),
  ...
  this.updatePayouts = function (a) {
    if (0 > a) var b = 0;
      ...
      for (b = 0; b < PAYOUTS[a].hits.length; b++)
        (k[b].text = PAYOUTS[a].hits[b]), (p[b].text = PAYOUTS[a].pays[b]);
  ...
  this.stopHighlight = function () {
    k[d] &&
      (createjs.Tween.removeTweens(k[d]),
      createjs.Tween.removeTweens(p[d]),
      (k[d].alpha = 1),
      (p[d].alpha = 1));
  };
  var n = this;
...
function CAnimBalls(a, c) {
  ...
  this._init = function (a, c) {
    ...
    for (var h = 0; 28 > h; h++) {
      ...
      e[h] = createSprite(
        m,
        p,
        n.width / NUM_DIFFERENT_BALLS / 2,
        n.height / 2,
        n.width / NUM_DIFFERENT_BALLS,
        n.height
      );
      e[h].gotoAndStop(p);
      e[h].x = a;
      h > f
        ? ((e[h].alpha = 0),
          (e[h].scaleX = e[h].scaleY = 0),
          (e[h].y = c + f * d))
        : ((e[h].y = c + h * d), (k[h] = c + h * d));
    }
  ...
  this.resetBalls = function () {
    for (var b = 0; 28 > b; b++) {
      ...
      e[b].x = a;
      if (b <= f)
        (e[b].y = c + b * d), e[b].gotoAndStop(e[20 + b].currentFrame);
      else if (b > f) {
        ...
        (k = Math.floor(Math.random() * NUM_DIFFERENT_BALLS)),
          e[b].gotoAndStop(k),
          (e[b].y = c + b * d);
