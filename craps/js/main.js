...
for (
  var aValues = [4, 5, 6, 8, 9, 10],
    aInfosLay =
      "1:2 ON 7 BEFORE POINT LESS 5% OF WIN;2:3 ON 7 BEFORE POINT LESS 5% OF WIN;5:6 ON 7 BEFORE POINT LESS 5% OF WIN;5:6 ON 7 BEFORE POINT LESS 5% OF WIN;2:3 ON 7 BEFORE POINT LESS 5% OF WIN;1:2 ON 7 BEFORE POINT LESS 5% OF WIN".split(
        ";"
      ),
    aInfosLose =
      "5:11 ON 7 BEFORE POINT;5:8 ON 7 BEFORE POINT;4:5 ON 7 BEFORE POINT;4:5 ON 7 BEFORE POINT;5:8 ON 7 BEFORE POINT;5:11 ON 7 BEFORE POINT".split(
        ";"
      ),
    aInfosBuy =
      "2:1 ON MAKING POINT LESS 5% OF BET;3:2 ON MAKING POINT LESS 5% OF BET;6:5 ON MAKING POINT LESS 5% OF BET;6:5 ON MAKING POINT LESS 5% OF BET;3:2 ON MAKING POINT LESS 5% OF BET;2:1 ON MAKING POINT LESS 5% OF BET".split(
        ";"
      ),
    aInfosWin =
      "9:5 ON MAKING POINT;7:5 ON MAKING POINT;7:6 ON MAKING POINT;7:6 ON MAKING POINT;7:5 ON MAKING POINT;9:5 ON MAKING POINT".split(
        ";"
      ),
    i = 0;
  i < aValues.length;
...
function CBetTableButton(a, g, d, e, h) {
  ...
  this.mouseOver = function () {
    b[ON_MOUSE_OVER] &&
      b[ON_MOUSE_OVER].call(f[ON_MOUSE_OVER], {
        enlight: c,
      });
  };
  this.mouseOut = function () {
...
function CCreditsPanel() {
  ...
  this._init = function () {
    ...
    p.y = CANVAS_HEIGHT / 2;
    f.addChild(p);
    b = new createjs.Text(TEXT_LINK, "30px Arial", "#ffffff");
    b.x = CANVAS_WIDTH / 2;
    b.y = 444;
    b.textAlign = "center";
    f.addChild(b);
